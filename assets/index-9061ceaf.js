(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const h of i)if(h.type==="childList")for(const l of h.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function t(i){const h={};return i.integrity&&(h.integrity=i.integrity),i.referrerpolicy&&(h.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?h.credentials="include":i.crossorigin==="anonymous"?h.credentials="omit":h.credentials="same-origin",h}function s(i){if(i.ep)return;i.ep=!0;const h=t(i);fetch(i.href,h)}})();function w(){}function me(a){return a()}function he(){return Object.create(null)}function z(a){a.forEach(me)}function fe(a){return typeof a=="function"}function A(a,e){return a!=a?e==e:a!==e||a&&typeof a=="object"||typeof a=="function"}function de(a){return Object.keys(a).length===0}function r(a,e){a.appendChild(e)}function C(a,e,t){a.insertBefore(e,t||null)}function v(a){a.parentNode&&a.parentNode.removeChild(a)}function o(a){return document.createElement(a)}function be(a){return document.createTextNode(a)}function p(){return be(" ")}function b(a,e,t){t==null?a.removeAttribute(e):a.getAttribute(e)!==t&&a.setAttribute(e,t)}function ge(a){return Array.from(a.childNodes)}function ye(a,e,t,s){t===null?a.style.removeProperty(e):a.style.setProperty(e,t,s?"important":"")}let Q;function I(a){Q=a}const E=[],ne=[],P=[],pe=[],ve=Promise.resolve();let W=!1;function je(){W||(W=!0,ve.then(we))}function Y(a){P.push(a)}const J=new Set;let R=0;function we(){const a=Q;do{for(;R<E.length;){const e=E[R];R++,I(e),ke(e.$$)}for(I(null),E.length=0,R=0;ne.length;)ne.pop()();for(let e=0;e<P.length;e+=1){const t=P[e];J.has(t)||(J.add(t),t())}P.length=0}while(E.length);for(;pe.length;)pe.pop()();W=!1,J.clear(),I(a)}function ke(a){if(a.fragment!==null){a.update(),z(a.before_update);const e=a.dirty;a.dirty=[-1],a.fragment&&a.fragment.p(a.ctx,e),a.after_update.forEach(Y)}}const O=new Set;let Se;function k(a,e){a&&a.i&&(O.delete(a),a.i(e))}function $(a,e,t,s){if(a&&a.o){if(O.has(a))return;O.add(a),Se.c.push(()=>{O.delete(a),s&&(t&&a.d(1),s())}),a.o(e)}else s&&s()}function M(a){a&&a.c()}function S(a,e,t,s){const{fragment:i,after_update:h}=a.$$;i&&i.m(e,t),s||Y(()=>{const l=a.$$.on_mount.map(me).filter(fe);a.$$.on_destroy?a.$$.on_destroy.push(...l):z(l),a.$$.on_mount=[]}),h.forEach(Y)}function x(a,e){const t=a.$$;t.fragment!==null&&(z(t.on_destroy),t.fragment&&t.fragment.d(e),t.on_destroy=t.fragment=null,t.ctx=[])}function xe(a,e){a.$$.dirty[0]===-1&&(E.push(a),je(),a.$$.dirty.fill(0)),a.$$.dirty[e/31|0]|=1<<e%31}function _(a,e,t,s,i,h,l,u=[-1]){const n=Q;I(a);const c=a.$$={fragment:null,ctx:[],props:h,update:w,not_equal:i,bound:he(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(e.context||(n?n.$$.context:[])),callbacks:he(),dirty:u,skip_bound:!1,root:e.target||n.$$.root};l&&l(c.root);let d=!1;if(c.ctx=t?t(a,e.props||{},(m,f,...g)=>{const T=g.length?g[0]:f;return c.ctx&&i(c.ctx[m],c.ctx[m]=T)&&(!c.skip_bound&&c.bound[m]&&c.bound[m](T),d&&xe(a,m)),f}):[],c.update(),d=!0,z(c.before_update),c.fragment=s?s(c.ctx):!1,e.target){if(e.hydrate){const m=ge(e.target);c.fragment&&c.fragment.l(m),m.forEach(v)}else c.fragment&&c.fragment.c();e.intro&&k(a.$$.fragment),S(a,e.target,e.anchor,e.customElement),we()}I(n)}class G{$destroy(){x(this,1),this.$destroy=w}$on(e,t){if(!fe(t))return w;const s=this.$$.callbacks[e]||(this.$$.callbacks[e]=[]);return s.push(t),()=>{const i=s.indexOf(t);i!==-1&&s.splice(i,1)}}$set(e){this.$$set&&!de(e)&&(this.$$.skip_bound=!0,this.$$set(e),this.$$.skip_bound=!1)}}function Ae(a){let e;return{c(){e=o("div"),e.innerHTML=`<div id="groupsio_unstyled_embed_signup"><form action="" method="post" id="groupsio-embedded-subscribe-form" name="groupsio-embedded-subscribe-form" target="_blank"><div id="groupsio_unstyled_embed_signup_scroll"><input disabled="" type="email" value="" name="email" class="email input input-bordered input-primary mt-5" id="email" placeholder="email address"/> 
      ...
      <input disabled="" type="submit" value="Subscribe" name="subscribe" id="groupsio-embedded-subscribe" class="my-5 button btn btn-primary btn-md"/></div></form></div>`,b(e,"class","unstyledtemplate template"),ye(e,"display","block")},m(t,s){C(t,e,s)},p:w,i:w,o:w,d(t){t&&v(e)}}}class Ce extends G{constructor(e){super(),_(this,e,null,Ae,A,{})}}function _e(a){let e;return{c(){e=o("ul"),e.innerHTML=`<li><a href="https://360environmental.com.au/careers/">360Environmental</a></li> 
	...
	<li><a href="https://wyvern.space/careers/">Wyvern</a></li>`,b(e,"class","list-disc text-left")},m(t,s){C(t,e,s)},p:w,i:w,o:w,d(t){t&&v(e)}}}class Ge extends G{constructor(e){super(),_(this,e,null,_e,A,{})}}function Te(a){let e,t,s,i,h,l,u;return l=new Ge({}),{c(){e=o("div"),t=o("h2"),t.textContent="Tracked Companies",s=p(),i=o("p"),i.innerHTML=`The geospatial companies come from <a href="https://github.com/chrieke/awesome-geospatial-companies">this excellent list by Christoph Rieke</a>.
    The names of the companies (and the careers page the newsletter monitors) are available below.`,h=p(),M(l.$$.fragment)},m(n,c){C(n,e,c),r(e,t),r(e,s),r(e,i),r(e,h),S(l,e,null),u=!0},p:w,i(n){u||(k(l.$$.fragment,n),u=!0)},o(n){$(l.$$.fragment,n),u=!1},d(n){n&&v(e),x(l)}}}class Ee extends G{constructor(e){super(),_(this,e,null,Te,A,{})}}function Ie(a){let e,t,s,i,h,l,u,n,c,d,m,f,g,T,j,Z,D,ee,N,ae,B,te,V,re,q,ie,K,se,H,oe,U,le,L,ce,X,F;return j=new Ee({props:{id:"companies"}}),{c(){e=o("div"),t=o("article"),s=o("h2"),s.textContent="Table of Contents",i=p(),h=o("ul"),h.innerHTML=`<li><a href="#desc">What is this?</a></li> 
            ...
            <li><a href="#contribution">How do I contribute?</a></li>`,l=p(),u=o("h2"),u.textContent="What is this?",n=p(),c=o("p"),c.textContent=`The Geospatial Jobs Monitor is a newsletter that tells you which geospatial companies might have posted new jobs.
        It is automatically detects changes in the careers pages so that you can see positions as soon as they are posted.`,d=p(),m=o("p"),m.textContent="Newsletters are sent on Tuesdays and Fridays at 7am GMT.",f=p(),g=o("p"),g.innerHTML=`This newsletter is a firehose - there is no way to filter the type of jobs you get you&#39;re interested in, no way
        to filter by country, and no sure-fire way to tell whether the company&#39;s job page has added a job or removed one.
        For a more curated newsletter, I&#39;d recommend you subscribe to <a href="#comparison">one of the other incredible geospatial newsletters out there.</a>`,T=p(),M(j.$$.fragment),Z=p(),D=o("h2"),D.textContent="How does this compare to other newsletters?",ee=p(),N=o("p"),N.textContent=`I made this newsletter so that I could see as many potential opportunities as possible without having to check the careers pages of companies
            that I cared about.`,ae=p(),B=o("p"),B.textContent=`If you are looking less actively, or just want a more curated list, there are many other incredible sources
            for jobs in the geospatial industry.`,te=p(),V=o("p"),V.innerHTML=`To start, there is the <a href="">Geospatial Jobs Newsletter</a> by Ali Ahmadalipour. This is a curated newsletter that
            focuses primarily on US-based companies in more technical positions.`,re=p(),q=o("p"),q.innerHTML='<a href="https://discourse.pangeo.io/c/news/jobs/14">Pangeo also has a job board</a> for specifically geospatial jobs.',ie=p(),K=o("p"),K.innerHTML=`For jobs in space, AI, Climate, I&#39;d recommend looking at the <a href="https://github.com/DahnJ/EO-jobs#portals--jobs">collection of job portals by Daniel Jahn</a>
        He has also collated a bunch of valuable information specifically for jobs in Earth observation, but there is a lot of interesting information for geospatial more generally as well.`,se=p(),H=o("h2"),H.textContent="How was this made?",oe=p(),U=o("p"),U.innerHTML=`This newsletter was made using <a href="https://webchanges.readthedocs.io/en/stable/">webchanges</a>, <a href="https://modal.com/">Modal</a> and <a href="groups.io">Groups.io</a>.
            ...
            The source code is available in <a href="https://github.com/dchirst/geospatialjobs">this repository</a>.`,le=p(),L=o("h2"),L.textContent="How do I contribute?",ce=p(),X=o("p"),X.innerHTML=`If you want to add a company, have found a mistake, or want to make any other improvement, please
            <a href="https://github.com/dchirst/geospatialjobs/issues">submit an issue</a> or add a comment on
            <a href="https://docs.google.com/spreadsheets/d/1YieNiDHVTC5CfX13n72fXuceDaubSuyrghgAnxipsbY/edit#gid=0">the Google Sheet</a>.`,b(u,"id","desc"),b(c,"class",""),b(D,"id","comparison"),b(H,"id","infra"),b(L,"id","contribution"),b(t,"class","prose prose-p:text-left")},m(y,ue){C(y,e,ue),r(e,t),r(t,s),r(t,i),r(t,h),r(t,l),r(t,u),r(t,n),r(t,c),r(t,d),r(t,m),r(t,f),r(t,g),r(t,T),S(j,t,null),r(t,Z),r(t,D),r(t,ee),r(t,N),r(t,ae),r(t,B),r(t,te),r(t,V),r(t,re),r(t,q),r(t,ie),r(t,K),r(t,se),r(t,H),r(t,oe),r(t,U),r(t,le),r(t,L),r(t,ce),r(t,X),F=!0},p:w,i(y){F||(k(j.$$.fragment,y),F=!0)},o(y){$(j.$$.fragment,y),F=!1},d(y){y&&v(e),x(j)}}}class $e extends G{constructor(e){super(),_(this,e,null,Ie,A,{})}}function Me(a){let e;return{c(){e=o("div"),e.innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" class="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg> 
<div class="inline">This newsletter has been deprecated. If you&#39;d like to see the Geospatial companies and their career pages
...
. Thank you for coming!</div>`,b(e,"class","alert alert-warning mx-auto max-w-lg my-5")},m(t,s){C(t,e,s)},p:w,i:w,o:w,d(t){t&&v(e)}}}class De extends G{constructor(e){super(),_(this,e,null,Me,A,{})}}function He(a){let e,t,s,i,h,l,u,n,c,d,m;return l=new De({}),n=new Ce({}),d=new $e({}),{c(){e=o("main"),t=o("h1"),t.textContent="AutoGeoJobs",s=p(),i=o("h2"),i.textContent="A bi-weekly auto-generated newsletter for jobs in the geospatial industry",h=p(),M(l.$$.fragment),u=p(),M(n.$$.fragment),c=p(),M(d.$$.fragment),b(e,"class","w-full")},m(f,g){C(f,e,g),r(e,t),r(e,s),r(e,i),r(e,h),S(l,e,null),r(e,u),S(n,e,null),r(e,c),S(d,e,null),m=!0},p:w,i(f){m||(k(l.$$.fragment,f),k(n.$$.fragment,f),k(d.$$.fragment,f),m=!0)},o(f){$(l.$$.fragment,f),$(n.$$.fragment,f),$(d.$$.fragment,f),m=!1},d(f){f&&v(e),x(l),x(n),x(d)}}}class Le extends G{constructor(e){super(),_(this,e,null,He,A,{})}}new Le({target:document.getElementById("app")});
